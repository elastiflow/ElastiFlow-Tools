...
install_elastiflow() {
  case "$DATA_PLATFORM" in
    ...
    "OpenSearch")
      ...
      "EF_OUTPUT_OPENSEARCH_INDEX_TEMPLATE_ISM_POLICY" "EF_OUTPUT_OPENSEARCH_INDEX_TEMPLATE_ISM_POLICY: 'elastiflow'"
      #added ISM
      "EF_OUTPUT_OPENSEARCH_INDEX_PERIOD" "EF_OUTPUT_OPENSEARCH_INDEX_PERIOD: 'rollover'"
