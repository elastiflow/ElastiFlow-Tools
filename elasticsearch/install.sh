...
install_elasticsearch() {
  ...
  elastic_install_log=$(apt-get -q update && apt-get -q install elasticsearch | stdbuf -oL tee /dev/console) || handle_error "Failed to install Elasticsearch." "${LINENO}"
...
install_kibana() {
  ...
  apt-get -q update && apt-get -q install kibana
